      ...
      <div class="card-body">
           ...
           <div class="row">
            <div class="col-md-4 mx-auto ">
                    ...
                    <asp:DropDownList ID="drpProgramList" runat="server" CssClass="btn btn-default btn-sm dropdown-toggle" DataSourceID="SqlDataSource1" DataTextField="ProgramName" DataValueField="ProgramID" AppendDataBoundItems="True" OnSelectedIndexChanged="drpProgramList_SelectedIndexChanged">
               ...
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:connString %>" SelectCommand="SELECT [ProgramID], [ProgramName] FROM [Program]"></asp:SqlDataSource>
                    ...
                    <asp:DropDownList ID="drpLocationTypeList" runat="server" CssClass="btn btn-default btn-sm dropdown-toggle">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="card-body">
        <div class="container-fluid" style="padding-top: 20px;">
                                ...
                                <asp:UpdatePanel runat="server" ID="clientPanel" UpdateMode="Conditional">
                        <ContentTemplate>
