            ...
            <div class="SimpleContainer col-sm-12 col-xs-12 col-md-4 col-lg-4 col-xl-4" style="z-index: 100;">
                ...
                <span class="price" style="color: black"><i class="fa fa-shopping-cart"></i><b>
                    ...
                    <div id="programOne" runat="server" visible="false">
                        <p>
                            <a href="#" data-toggle="modal" data-target="#EditProgramOne">
                    ...
                    <div id="programTwo" runat="server" visible="false">
                        <p>
                            <a href="#" data-toggle="modal" data-target="#EditProgramTwo">
                    ...
                    <asp:UpdatePanel ID="cartUp" runat="server">
                        <ContentTemplate>
                            <p>
                                <a href="#" data-toggle="modal" data-target="#EditMileageCost">
                            ...
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    ...
                                    <asp:TextBox ID="programTime" runat="server" type="time" step="900" min="8:00" max="17:00"></asp:TextBox>
                                            ...
                                            <div class="col-md-4 mx-auto  Spacing">
                                                <label>Adults </label>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAdults"
                                                    ErrorMessage="*" ForeColor="Red" ValidationGroup="addProgram"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="col-md-4 mx-auto  Spacing">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtKids"
                                                    ErrorMessage="*" ForeColor="Red" ValidationGroup="addProgram"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mx-auto Spacing">
                                                ...
                                                <asp:DropDownList ID="drpAgeLevel" runat="server">
                                                    <asp:ListItem Value="0" Text="Select an Age Level"></asp:ListItem>
                                            ...
                                            <div class="main-container">
                                                <div class="row">
                                                   ...
                                                   <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label ID="lblStreet" runat="server" class="label-style">Street Address</label>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label ID="lblMileage1" runat="server" class="label-style">Mileage</label>
                                                    </div>
                                                    <div class="form-group col-md-6">
