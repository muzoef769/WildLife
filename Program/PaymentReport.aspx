...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
  ...
  <thead>
    <tr class="table-success">
      <td ><asp:Button href="#" ID="btnJan" runat="server" Text="January" OnClick="btnJan_Click" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
      <td ><asp:Button href="#" ID="btnFeb" runat="server" Text="February" OnClick="btnFeb_Click"  scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
      <td ><asp:Button href="#" ID="btnMar" runat="server" Text="March" OnClick="btnMar_Click" scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
      <td ><asp:Button href="#" ID="btnApr" runat="server" Text="April" OnClick="btnApr_Click" scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
        <td><asp:Button href="#"  ID="btnMay" runat="server" Text="May" OnClick="btnMay_Click" scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
      <td ><asp:Button href="#" ID="btnJun" runat="server" Text="June" OnClick="btnJun_Click" scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
      <td ><asp:Button href="#" ID="btnJul" runat="server" Text="July" OnClick="btnJul_Click" scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
      <td ><asp:Button href="#" ID="btnAug" runat="server" Text="August" OnClick="btnAug_Click" scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
      <td ><asp:Button href="#" ID="btnSep" runat="server" Text="September" OnClick="btnSep_Click" scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
      <td ><asp:Button href="#" ID="btnOct" runat="server" Text="October" OnClick="btnOct_Click" scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
      <td ><asp:Button href="#"  ID="btnNov" runat="server" Text="November" OnClick="btnNov_Click" scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
      <td ><asp:Button href="#"  ID="btnDec" runat="server" Text="December" OnClick="btnDec_Click" scope="col" style="color:black; text-decoration:none;  background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden; "></asp:Button></td>
        ...
        <br />
            ...
            <div id="ann" class="col-xl-7 col-lg-12 col-md-12 col-s-12 ">
                ...
                <asp:Button id="Button1" class=" btn btn-primary PayButton2 mx-auto d-flex justify-content-center" runat="server" Text="Export To Excel" onclick="Button1_Click"></asp:Button>
            </div>
